...
from model.chord_formulas import (AUGChord, DIM7Chord, DIMChord, DOM7Chord,
                                  DOM9Chord, DOM11Chord, DOM13Chord, MAJ7Chord,
                                  MAJ9Chord, MAJ11Chord, MAJ13Chord, MAJChord,
                                  MIN7Chord, MIN9Chord, MIN11Chord, MIN13Chord,
                                  MINChord)
...
class TemplateParser:
    Parts = namedtuple('Parts', ['main_note', 'main_accid', 'triad', 'compound_accid',
    ...
    def _resolve_base_match(self, parts):
        chord_switcher = {
            ('maj', None): MAJChord,
            ('min', None): MINChord,
            ('dim', None): DIMChord,
    ...
    def _resolve_addons(self, chord, parts):
    ...
    def _resolve_modifications(self, chord, parts):
    ...
    def _get_composition(self, chord_formula):
        ...
        parts = self.Parts(*parsed_formula[0])
    ...
    def parse_init_cond(self, init_notes):
